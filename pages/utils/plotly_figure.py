...
def close_chart(dataframe, num_period = False):
    ...
    fig.update_layout(height = 500, margin=dict(l=0, r=20, t=20, b=0), plot_bgcolor = 'white', paper_bgcolor = '#e1efff', legend=dict(yanchor="top",
                xanchor="right"))
    return fig
...
def RSI(dataframe, num_period):
    ...
    fig.update_layout(yaxis_range=[0,100],
                      height=200,plot_bgcolor = "white", paper_bgcolor='#e1efff', margin=dict(l=0, r=0, t=0, b=0), legend=dict(orientation="h", yanchor="top",
                      y=1.02,
                      xanchor="right",
                      x=1))
    return fig
...
def MACD(dataframe, num_period):
    ...
    fig.add_trace(go.Scatter(
        x=dataframe['Date'],
        y=dataframe['MACD Signal'], name='Signal', marker_color='red', line=dict(width=2, color='red', dash='dash'),
    ))
